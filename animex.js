...
//         const isM3U8 = /\.m3u8/i.test(s.streamUrl);
...
//         console.log(`\n# 1. Download video:`);
//         if (isM3U8) {
//             console.log(`python -m yt_dlp --add-header "Referer:${refHeader}" --add-header "Origin:https://animex.one" --add-header "User-Agent:Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:151.0) Gecko/20100101 Firefox/151.0" --downloader ffmpeg --hls-use-mpegts -o "output.mp4" "${s.streamUrl}"`);
//         } else {
...
//         if (subtitle) {
//             console.log(`python -m yt_dlp "${subtitle}" -o "subs.vtt"`);
//         } else {
...
async function extractStreamUrl(url) {
    try {
        ...
        async function fetchProviderStream(provider, type) {
            ...
            // Normalize header keys to Title-Case (handles multi-word like User-Agent)
